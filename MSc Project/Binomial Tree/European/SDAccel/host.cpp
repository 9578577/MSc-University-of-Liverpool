...
int main(int argc, char **argv) {
    ...
    while(fgets(linebuf, sizeof(linebuf), file) != NULL) {
        ...
        sscanf(linebuf, "%f,%f,%f,%f,%f,%f,%d,%d", &S[num_options], &K[num_options], &T[num_options], &D[num_options], &r[num_options], &v[num_options], &height[num_options], &steps[num_options]);
